  ...
  elevated_cool: {
    A: { name: "Downtown Tailoring", materials: ["fine wool", "stiff cotton", "smooth leather", "cashmere", "silk", "gabardine", "poplin", "neoprene", "satin"],
      items: {
        ...
        mid: ["cashmere turtleneck", "ribbed mock-neck top", "fine-knit vest", "silk base layer", "wool polo", "structured bustier", "sleeveless vest", "merino crew neck", "slim-fit rollneck", "lightweight cashmere sweater", "silk mock-neck shell", "cotton ribbed tank", "fine-gauge pullover", "seamless thermal top", "jersey turtleneck", "knit polo vest", "waffle thermal layer", "modal base layer"],
      } },
    B: { name: "Neo-Prep Edge", materials: ["tweed", "corduroy", "denim", "cable-knit", "velvet", "wool", "oxford cloth", "flannel"],
      items: {
        ...
        mid: ["cable-knit sweater", "argyle vest", "rollneck knit", "fine cotton cardigan", "cricket sweater", "fair isle knit", "V-neck wool pullover", "button-front vest", "lambswool crew neck", "quarter-zip knit", "thermal henley layer", "cotton mock-neck", "sleeveless cable vest", "ribbed polo neck", "tweed waistcoat", "merino zip cardigan", "lightweight jumper", "rugby knit layer"],
      } },
    C: { name: "High-End Street", materials: ["nylon", "leather", "tech-fleece", "mesh", "neoprene", "denim", "ripstop", "reflective fabric"],
      items: {
        ...
        mid: ["logo sweatshirt", "zip-up fleece", "cropped hoodie", "tech half-zip", "corset hoodie", "cashmere hoodie", "neoprene pullover", "mesh long sleeve layer", "thermal crew neck", "ribbed bodysuit", "oversized crewneck", "quarter-zip fleece", "fitted mock-neck", "sleeveless hoodie layer", "jersey turtleneck", "compression base layer", "padded vest layer", "zip polo layer"],
      } },
  },
  effortless_natural: {
    A: { name: "Japandi Flow", materials: ["linen", "cotton", "raw silk", "gauze", "hemp", "wool", "bamboo", "organic cotton"],
      items: {
        ...
        mid: ["linen cardigan", "waffle-knit top", "cotton ribbed vest", "gauze layer top", "kimono cardigan", "knitted vest", "hemp henley", "organic cotton tank", "raw silk camisole", "bamboo thermal top", "linen mock-neck", "soft wool pullover", "cotton waffle layer", "gauze wrap top", "lightweight poncho layer", "open-knit vest", "raglan base layer", "sleeveless tunic layer"],
      } },
    B: { name: "French Casual", materials: ["cotton", "silk", "wool", "cashmere", "linen", "denim", "boucle", "poplin"],
      items: {
        ...
        mid: ["cashmere crew-neck", "cotton cardigan", "fine-knit pullover", "silk layer top", "cropped cardigan", "v-neck sweater", "boucle knit vest", "merino wool polo", "silk camisole layer", "cotton turtleneck", "poplin shirt layer", "ribbed tank top", "lace trim cami", "lightweight wool crew", "button cardigan", "sheer blouse layer", "fitted jersey top", "cashmere wrap layer"],
      } },
    C: { name: "Soft Amekaji", materials: ["denim", "flannel", "canvas", "waxed cotton", "wool", "corduroy", "chambray", "canvas duck"],
      items: {
        ...
        mid: ["waffle henley", "cotton cardigan", "flannel overshirt", "sherpa vest", "fair isle knit", "knitted vest", "chambray button layer", "heavy cotton henley", "wool zip vest", "canvas work shirt layer", "corduroy overshirt", "thermal crew layer", "fleece pullover", "denim shirt layer", "quilted liner vest", "cable-knit pullover", "waxed cotton vest", "raglan sweatshirt layer"],
      } },
  },
  artistic_minimal: {
    A: { name: "Gallery Uniform", materials: ["wool", "cotton", "linen", "silk", "neoprene", "jersey", "poplin", "gabardine"],
      items: {
        ...
        mid: ["ribbed tank top", "mock-neck knit", "fine-gauge turtleneck", "seamless layer top", "structured tank", "longline vest", "neoprene shell top", "silk jersey layer", "minimal bodysuit", "cotton poplin shell", "gabardine vest", "architectural tank", "jersey mock-neck", "linen sleeveless top", "funnel neck knit", "panelled base layer", "raw-edge tank", "geometric knit layer"],
      } },
    B: { name: "Texture Mix", materials: ["boucle", "velvet", "organza", "mohair", "patent leather", "jacquard", "metallic fabric", "lace"],
      items: {
        ...
        mid: ["mohair knit vest", "sheer mesh layer", "bodycon turtleneck", "draped knit top", "boucle knit top", "ribbed tank", "velvet camisole layer", "organza shell", "metallic knit vest", "lace long sleeve layer", "crushed satin cami", "angora pullover", "jacquard vest", "pearl trim tank", "sequin knit layer", "feather trim top", "lurex turtleneck", "textured wool layer"],
      } },
    C: { name: "Soft Avant-Garde", materials: ["jersey", "gauze", "chiffon", "knit", "linen", "silk", "cotton voile", "modal"],
      items: {
        ...
        mid: ["ribbed knit vest", "linen layer shirt", "asymmetric knit top", "gauze draped layer", "soft corset", "jersey tunic", "chiffon shell layer", "modal wrap top", "cotton voile cami", "knit bodysuit", "draped jersey vest", "silk gauze layer", "mesh turtleneck", "sheer knit pullover", "bias-cut tank", "fluid mock-neck", "layered jersey top", "gathered knit layer"],
      } },
  },
  retro_luxe: {
    A: { name: "Opulent Folklore", materials: ["suede", "velvet", "brocade", "embroidered fabric", "tapestry", "silk", "crochet", "lace"],
      items: {
        ...
        mid: ["crochet vest", "embroidered cardigan", "suede fringe vest", "printed silk layer", "folk cardigan", "knit bodice", "velvet bodice layer", "lace camisole layer", "tapestry vest", "silk peasant blouse", "brocade corset layer", "embroidered tunic layer", "sheer lace top", "smocked crop layer", "ruffled shell", "balloon sleeve blouse", "floral knit vest", "victorian cami layer"],
      } },
    B: { name: "70s Vintage Chic", materials: ["suede", "corduroy", "crochet", "satin", "velvet", "denim", "lurex", "silk"],
      items: {
        ...
        mid: ["crochet vest", "suede fringe vest", "printed silk layer", "corduroy blazer", "knitted polo", "lurex top", "satin halter layer", "velvet turtleneck", "disco knit tank", "ribbed henley layer", "western shirt layer", "tie-dye cami", "denim vest layer", "pussy-bow blouse layer", "peasant crop layer", "bell sleeve knit", "suede vest layer", "wrap knit top"],
      } },
    C: { name: "Old Money", materials: ["cashmere", "tweed", "silk", "wool", "leather", "velvet", "brocade", "herringbone"],
      items: {
        ...
        mid: ["cashmere turtleneck", "fine-knit vest", "cable-knit cardigan", "argyle sweater", "twin-set", "sleeveless knit", "merino polo layer", "silk shell top", "wool crew-neck", "herringbone waistcoat", "cotton oxford layer", "tweed vest", "lambswool pullover", "ribbed cashmere tank", "button-front cardigan", "cricket jumper layer", "quilted gilet layer", "collared knit vest"],
      } },
  },
  sport_modern: {
    A: { name: "City Tech Gorpcore", materials: ["gore-tex", "ripstop", "fleece", "nylon", "cordura", "mesh", "softshell", "merino"],
      items: {
        ...
        mid: ["half-zip fleece", "merino pullover", "grid fleece vest", "base layer long sleeve", "tech-fleece top", "thermal top", "softshell vest layer", "compression long sleeve", "merino mock-neck", "mesh base layer", "insulated gilet", "performance henley", "nylon zip vest", "windproof mid layer", "trail running top", "grid fleece pullover", "tech wool crew", "seamless thermal layer"],
      } },
    B: { name: "Athleisure Luxe", materials: ["jersey", "cotton", "nylon", "spandex", "mesh", "modal", "cashmere blend", "seamless knit"],
      items: {
        ...
        mid: ["ribbed crop top", "seamless tank", "sports bra layer", "fitted long sleeve", "yoga top", "corset top", "compression cami", "mesh racerback layer", "modal turtleneck", "jersey wrap layer", "cashmere blend crew", "off-shoulder sweat layer", "nylon bralette layer", "seamless mock-neck", "cropped hoodie layer", "spandex bodysuit", "knit halter layer", "thermal crop top"],
      } },
    C: { name: "Blokecore Jersey", materials: ["nylon", "polyester", "mesh", "cotton", "fleece", "track fabric", "velour", "satin"],
      items: {
        ...
        mid: ["training top", "half-zip top", "mesh top", "warm-up shirt", "zip neck top", "sleeveless jersey", "polyester drill layer", "velour zip top", "cotton crewneck layer", "fleece half-zip", "satin warm-up top", "vintage kit layer", "nylon mock-neck", "mesh long sleeve", "track fabric polo", "jersey base layer", "goalkeeper jersey layer", "retro knit polo"],
      } },
  },
  creative_layered: {
    A: { name: "Rock and Rebellion", materials: ["denim", "flannel", "leather", "jersey", "mesh", "lace", "vinyl", "plaid"],
      items: {
        ...
        mid: ["mesh layer top", "fishnet top", "flannel tied layer", "cropped hoodie", "corset top", "bustier", "lace camisole layer", "vinyl crop layer", "band tee layer", "jersey bodysuit", "plaid shirt layer", "ripped thermal", "leather bustier", "safety pin tank", "sheer mesh bodysuit", "studded vest layer", "slip top layer", "bralette harness layer"],
      } },
    B: { name: "Pattern Clash", materials: ["velvet", "silk", "crochet", "denim", "corduroy", "leather", "knit", "printed fabric"],
      items: {
        ...
        mid: ["crochet vest", "printed silk layer", "vintage cardigan", "lace layer top", "argyle vest", "knit top", "tie-dye tank layer", "floral cami layer", "polka dot blouse layer", "striped knit vest", "animal print shell", "patchwork knit layer", "geometric crop layer", "printed silk cami", "velvet vest layer", "corduroy vest layer", "Hawaiian shirt layer", "denim vest layer"],
      } },
    C: { name: "Vintage Eclectic", materials: ["velvet", "silk", "crochet", "corduroy", "leather", "tapestry", "lace", "embroidered fabric"],
      items: {
        ...
        mid: ["crochet vest", "printed silk layer", "vintage cardigan", "lace layer top", "velvet blazer", "embroidered jacket", "tapestry vest layer", "silk slip layer", "corduroy waistcoat", "leather vest layer", "lace bodysuit layer", "embroidered cami", "velvet turtleneck", "crochet crop layer", "thermal henley layer", "peasant blouse layer", "satin shell layer", "knit bodice layer"],
      } },
  },
};
