...
export const SUB_CATEGORY_STYLE: Record<string, string> = {
  ...
  tuxedo_jacket: 'formal', tuxedo_pants: 'formal', pinstripe_blazer: 'formal',
  pinstripe_slacks: 'formal', cigarette_pants: 'formal', slingbacks: 'formal',
  pumps: 'formal', court_heels: 'formal', kitten_heels: 'formal',
  structured_trench: 'formal', cape_blazer: 'formal', collarless_blazer: 'formal',
  envelope_clutch: 'formal', briefcase: 'formal', portfolio: 'formal',
  silk_button_down: 'formal', satin_blouse: 'formal', pussy_bow_blouse: 'formal',
  tie_neck_blouse: 'formal', wool_trousers: 'formal', silk_trousers: 'formal',
  maxi_pencil_skirt: 'formal', wrap_skirt: 'formal', structured_handbag: 'formal',
  kelly_bag: 'formal', top_handle_bag: 'formal', doctor_bag: 'formal',
  monk_straps: 'formal', brogues: 'formal', riding_boots: 'formal',
  knee_high_boots: 'formal', knee_boots: 'formal',
  pearl_necklace: 'formal', signet_ring: 'formal', crest_pin: 'formal',
  ...
  sweater: 'smart_casual', vest: 'smart_casual', tank: 'casual',
  tote: 'smart_casual', shoulder_bag: 'smart_casual', watch: 'smart_casual',
  coat: 'smart_casual', boot: 'smart_casual',
  cashmere_sweater: 'smart_casual', cashmere_turtle: 'smart_casual',
  cable_sweater: 'smart_casual', v_neck_sweater: 'smart_casual',
  wool_blazer: 'smart_casual', linen_blazer: 'smart_casual', tweed_jacket: 'smart_casual',
  houndstooth_jacket: 'smart_casual', herringbone_coat: 'smart_casual',
  camel_coat: 'smart_casual', cashmere_coat: 'smart_casual', peacoat: 'smart_casual',
  wrap_coat: 'smart_casual', wool_coat: 'smart_casual', overcoat: 'smart_casual',
  trench_coat_short: 'smart_casual', duster_coat: 'smart_casual',
  silk_blouse: 'smart_casual', poplin_shirt: 'smart_casual', oxford_shirt: 'smart_casual',
  button_down: 'smart_casual', linen_shirt: 'smart_casual',
  mock_neck: 'smart_casual', ribbed_knit: 'smart_casual', fine_turtleneck: 'smart_casual',
  boat_neck: 'smart_casual', breton_stripe: 'smart_casual',
  culottes: 'smart_casual', pleated_trousers: 'smart_casual', tailored_shorts: 'smart_casual',
  straight_jeans: 'smart_casual', white_jeans: 'smart_casual',
  pleated_skirt: 'smart_casual', silk_skirt: 'smart_casual', wool_skirt: 'smart_casual',
  chelsea_boots: 'smart_casual', ankle_boots: 'smart_casual',
  mary_janes: 'smart_casual', ballet_flats: 'smart_casual', mules: 'smart_casual',
  penny_loafer: 'smart_casual', horsebit_loafer: 'smart_casual',
  block_heels: 'smart_casual', wedge_heels: 'smart_casual',
  saddle_bag: 'smart_casual', baguette: 'smart_casual', bucket_bag: 'smart_casual',
  box_bag: 'smart_casual', frame_bag: 'smart_casual', satchel: 'smart_casual',
  chain_bag: 'smart_casual', vanity_case: 'smart_casual',
  silk_scarf: 'smart_casual', gold_hoops: 'smart_casual', beret: 'smart_casual',
  headband: 'smart_casual', pearl_studs: 'smart_casual', gold_bangle: 'smart_casual',
  tennis_bracelet: 'smart_casual',
  collarless_coat: 'smart_casual', kimono_jacket: 'smart_casual',
  longline_blazer: 'smart_casual', cocoon_coat: 'smart_casual',
  architectural_blazer: 'smart_casual', cape_coat: 'smart_casual',
  wrap_jacket: 'smart_casual', shawl_coat: 'smart_casual',
  tunic_shirt: 'smart_casual', poplin_tunic: 'smart_casual',
  barrel_pants: 'smart_casual', tapered_ankle_pants: 'smart_casual',
  tabi_boots: 'smart_casual', architectural_mules: 'smart_casual',
  geometric_bag: 'smart_casual', pleated_tote: 'smart_casual',
  sculptural_bangle: 'smart_casual', bold_eyewear: 'smart_casual',
  ...
  graphic_tee: 'casual', band_tee: 'casual', vintage_tee: 'casual', slogan_tee: 'casual',
  ringer_tee: 'casual', muscle_tank: 'casual', crop_top: 'casual',
  boxy_tee: 'casual', longline_tee: 'casual', oversized_tee: 'casual',
  henley: 'casual', thermal_henley: 'casual', raglan_tee: 'casual',
  flannel_shirt: 'casual', chambray_shirt: 'casual', denim_shirt: 'casual',
  work_shirt: 'casual', western_shirt: 'casual', hawaiian_shirt: 'casual',
  crewneck: 'casual', half_zip: 'casual',
  varsity_jacket: 'casual', bomber: 'casual', coach_jacket: 'casual',
  harrington: 'casual', shacket: 'casual', field_jacket: 'casual',
  chore_coat: 'casual', barn_jacket: 'casual', corduroy_jacket: 'casual',
  quilted_jacket: 'casual', anorak: 'casual',
  cargo_pants: 'casual', carpenter_jeans: 'casual', wide_chinos: 'casual',
  corduroy_pants: 'casual', fatigue_pants: 'casual', painter_pants: 'casual',
  overalls: 'casual', dungarees: 'casual', raw_denim: 'casual',
  baggy_jeans: 'casual', wide_denim: 'casual', flared_jeans: 'casual',
  ripped_jeans: 'casual', patchwork_jeans: 'casual',
  denim_skirt: 'casual', cargo_skirt: 'casual', mini_skirt: 'casual',
  maxi_skirt: 'casual', tiered_skirt: 'casual',
  desert_boots: 'casual', work_boots: 'casual', canvas_high_tops: 'casual',
  retro_sneakers: 'casual', slip_ons: 'casual', clogs: 'casual',
  espadrilles: 'casual', moccasins: 'casual', wallabees: 'casual',
  platform_boots: 'casual', combat_boots: 'casual', creepers: 'casual',
  messenger: 'casual', canvas_tote: 'casual', waist_bag: 'casual',
  sling_bag: 'casual', camera_bag: 'casual', fanny_pack: 'casual',
  drawstring_bag: 'casual', barrel_bag: 'casual', phone_pouch: 'casual',
  bandana: 'casual', bucket_hat: 'casual', choker: 'casual',
  chain_necklace: 'casual', silver_rings: 'casual', wristband: 'casual',
  leather_bracelet: 'casual', enamel_pin: 'casual', suspenders: 'casual',
  sunglasses: 'casual',
  kimono_cardigan: 'casual', noragi: 'casual', robe_coat: 'casual',
  linen_jacket: 'casual', poncho: 'casual', blanket_coat: 'casual',
  linen_tunic: 'casual', waffle_henley: 'casual', organic_tee: 'casual',
  wrap_top: 'casual', gauze_blouse: 'casual', hemp_shirt: 'casual',
  drawstring_pants: 'casual', balloon_pants: 'casual', harem_pants: 'casual',
  linen_trousers: 'casual', wide_linen_trousers: 'casual',
  suede_mules: 'casual', leather_slides: 'casual', babouche: 'casual',
  canvas_sneakers: 'casual', leather_sandals: 'casual', woven_flats: 'casual',
  cork_sandals: 'casual', knit_sneakers: 'casual',
  soft_hobo: 'casual', canvas_bucket: 'casual', knot_bag: 'casual',
  net_bag: 'casual', market_tote: 'casual', woven_bag: 'casual',
  straw_bag: 'casual', basket_bag: 'casual', macrame_bag: 'casual',
  crochet_bag: 'casual', furoshiki_bag: 'casual',
  ceramic_jewelry: 'casual', wooden_beads: 'casual', straw_hat: 'casual',
  leather_cuff: 'casual', woven_bracelet: 'casual',

  boucle_coat: 'smart_casual', velvet_blazer: 'smart_casual',
  shearling_jacket: 'smart_casual', embroidered_jacket: 'smart_casual',
  tapestry_jacket: 'smart_casual', brocade_coat: 'smart_casual',
  embroidered_blouse: 'smart_casual', lace_top: 'smart_casual',
  peasant_blouse: 'smart_casual', ruffled_blouse: 'smart_casual',
  velvet_bodice: 'smart_casual', victorian_shirt: 'smart_casual',
  velvet_trousers: 'smart_casual', velvet_skirt: 'smart_casual',
  tapestry_skirt: 'smart_casual', brocade_pants: 'smart_casual',
  velvet_boots: 'smart_casual', brocade_pumps: 'smart_casual',
  embroidered_boots: 'smart_casual', satin_heels: 'smart_casual',
  tapestry_bag: 'smart_casual', velvet_bag: 'smart_casual',
  embroidered_clutch: 'smart_casual', beaded_pouch: 'smart_casual',
  headscarf: 'smart_casual', cameo: 'smart_casual', locket: 'smart_casual',
  brooch: 'smart_casual', corset_belt: 'smart_casual',

  suede_jacket: 'casual', shearling_coat: 'casual', faux_fur: 'casual',
  leather_trench: 'smart_casual', safari_jacket: 'casual',
  patchwork_jacket: 'casual', crochet_cardigan: 'casual',
  fringe_vest: 'casual', western_jacket: 'casual',
  platform_sneakers: 'casual', cowboy_boots: 'casual',
  fringe_boots: 'casual', fringe_bag: 'casual',
  macrame_bag_retro: 'casual', guitar_strap_bag: 'casual',
  tinted_sunglasses: 'casual', wide_brim_hat: 'casual',
  aviators: 'casual', floppy_hat: 'casual', medallion: 'casual',

  tweed_jacket_old: 'smart_casual', quilted_jacket_old: 'smart_casual',
  gold_button_blazer: 'formal', cable_cardigan: 'smart_casual',
  barbour_jacket: 'smart_casual', navy_blazer: 'formal',
  polo_coat: 'smart_casual', sweater_vest: 'smart_casual',
  cable_sweater_old: 'smart_casual', cricket_jumper: 'smart_casual',
  argyle_vest: 'smart_casual', twin_set: 'smart_casual',
  riding_pants: 'smart_casual', tennis_skirt: 'casual',
  horsebit_loafers: 'formal', penny_loafers: 'smart_casual',
  tennis_sneakers: 'casual', deck_shoes: 'casual',
  monogram_bag: 'smart_casual', vanity_case_old: 'smart_casual',
  compact: 'smart_casual', collar_bar: 'formal',

  track_jacket: 'sporty', windbreaker: 'sporty', puffer: 'sporty',
  legging: 'sporty', leggings: 'sporty', track_pants: 'sporty',
  biker_shorts: 'sporty', running_shoe: 'sporty', training_shoe: 'sporty',
  sports_bag: 'sporty',
  shell_jacket: 'sporty', tech_trench: 'sporty', softshell: 'sporty',
  anorak_tech: 'sporty', rain_jacket: 'sporty', tactical_vest: 'sporty',
  mountain_parka: 'sporty', storm_coat: 'sporty',
  running_jacket: 'sporty', cycling_jacket: 'sporty', ski_jacket: 'sporty',
  performance_tee: 'sporty', compression_top: 'sporty', mesh_layer: 'sporty',
  baselayer: 'sporty', dry_fit_tee: 'sporty', rash_guard: 'sporty',
  tech_fleece: 'sporty', grid_fleece: 'sporty', sun_hoodie: 'sporty',
  waterproof_trousers: 'sporty', climbing_pants: 'sporty', wind_pants: 'sporty',
  tech_shorts: 'sporty', running_tights: 'sporty', ski_pants: 'sporty',
  cargo_joggers: 'sporty', hiking_shorts: 'sporty',
  gore_tex_sneakers: 'sporty', trail_runners: 'sporty', trekking_boots: 'sporty',
  hiking_boots: 'sporty', vibram_shoes: 'sporty', waterproof_boots: 'sporty',
  approach_shoes: 'sporty', running_shoes: 'sporty', recovery_slides: 'sporty',
  sacoche: 'sporty', chest_rig: 'sporty', hydration_pack: 'sporty',
  dry_bag: 'sporty', roll_top_bag: 'sporty', harness_bag: 'sporty',
  running_vest: 'sporty', stuff_sack: 'sporty',
  gaiter: 'sporty', gps_watch: 'sporty', fitness_tracker: 'sporty',
  paracord: 'sporty', carabiner: 'sporty',
  sports_bra: 'sporty', racerback: 'sporty', yoga_top: 'sporty',
  yoga_pants: 'sporty', unitard: 'sporty', flare_leggings: 'sporty',
  dance_pants: 'sporty', compression_shorts: 'sporty', cycling_shorts: 'sporty',
  sock_sneakers: 'sporty', training_shoes: 'sporty', yoga_shoes: 'sporty',
  dance_shoes: 'sporty', studio_wraps: 'sporty', barefoot_shoes: 'sporty',
  gym_bag: 'sporty', yoga_bag: 'sporty', mat_bag: 'sporty',
  sackpack: 'sporty', waist_pack: 'sporty',
  soccer_jersey: 'sporty', goalkeeper_jersey: 'sporty', basketball_jersey: 'sporty',
  hockey_jersey: 'sporty', baseball_shirt: 'sporty', rugby_shirt: 'sporty',
  training_top: 'sporty', drill_top: 'sporty',
  soccer_shorts: 'sporty', basketball_shorts: 'sporty', running_shorts: 'sporty',
  warm_up_pants: 'sporty', shell_pants: 'sporty',
  ...
  bustier: 'casual', slip_top: 'casual',
  tulle_skirt: 'casual', plaid_skirt: 'casual', leather_pants: 'casual',
  vinyl_skirt: 'casual', fishnet_tights: 'casual',
  studded_boots: 'casual', winklepickers: 'casual', moto_boots: 'casual',
  chain_bag_cl: 'casual', studded_bag: 'casual', coffin_bag: 'casual',
  safety_pin_bag: 'casual',
  safety_pins: 'casual', harness: 'casual', garter: 'casual',
  arm_warmer: 'casual', leg_warmer: 'casual', spikes: 'casual',

  patchwork_jacket_cl: 'casual', tapestry_coat: 'casual',
  polka_dot_blouse: 'casual', tie_dye: 'casual', animal_print: 'casual',
  checkered_pants: 'casual', patchwork_jeans_cl: 'casual', colored_denim: 'casual',
  novelty_bag: 'casual', neon_bag: 'casual', sequin_bag: 'casual',
  jelly_bag: 'casual',

  embroidered_jacket_cl: 'casual', capelet: 'casual',
  lace_blouse: 'casual', crochet_top: 'casual', slip_dress: 'casual',
  peasant_top: 'casual', smock: 'casual', bodice: 'casual',
  velvet_skirt_cl: 'casual', suspender_skirt: 'casual', bloomers: 'casual',
  petticoat: 'casual', knickers: 'casual',
  cowboy_boots_cl: 'casual', t_strap: 'casual', jellies: 'casual',
  tapestry_bag_cl: 'casual', needlepoint_bag: 'casual',
  locket_cl: 'casual', hat_pin: 'casual', fan: 'casual',
};
