      ...
      >
        {images.map((image, index) => (
          <div
            ...
            style={{ aspectRatio: isMobile ? '16 / 9' : '1.91 / 1' }}
          >
            <img
              src={image}
              ...
              onError={(e) => {
                ...
                if (parent) {
                  parent.innerHTML = `<div class="w-full h-full flex items-center justify-center text-gray-400 text-sm">Image ${index + 1} not found</div>`;
                }
              }}
              onLoad={() => {
