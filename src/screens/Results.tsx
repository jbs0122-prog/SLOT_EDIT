...
export default function Results({ outfits, context, onBack }: ResultsProps) {
  ...
  return (
    <div className="h-screen flex flex-col bg-white">
      ...
      <div className="flex-1 overflow-y-scroll snap-y snap-mandatory" style={{ marginTop: '62px' }}>
          ...
          sortedOutfits.map((outfit, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="h-[22vh] md:h-auto md:w-[500px] md:max-h-[80vh] overflow-y-auto px-6 py-2 md:py-0 flex flex-col">
      ...
      {sortedOutfits.length > 1 && (
        <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 h-[4vh] z-40 flex items-center justify-center gap-2">
